...
|---|---|---|---|---|---|
| codex_draft | [LM-Searcher: Cross-domain Neural Architecture Search with LLMs via Unified Numerical Encoding](https://aclanthology.org/2025.emnlp-main.478/) | 2025/EMNLP Main | `llm-nas`, `ranking`, `numerical-encoding`, `transformer`, `lora-rank` | [解析](parsed/2025-emnlp-lm-searcher.md) | 获取 paper-exact evaluators/manifests，以固定候选池和相同 evaluator 预算复现，并补 SFT/搜索 tokens、GPU-hours 与真实设备 latency |
...
| codex_draft | [TacEvo: Self-Evolving Architecture Discovery for Robotic Tactile Perception via LLM-Driven Quality-Diversity Search](https://arxiv.org/abs/2606.30109) | 2026/arXiv | `llm-nas`, `quality-diversity`, `code-generation` | [解析](parsed/2026-arxiv-tacevo.md) | 核对高保真训练/硬件/LLM 成本，并做 matched-budget QD 消融 |
...
| codex_draft | [RZ-NAS: Enhancing LLM-guided Neural Architecture Search via Reflective Zero-Cost Strategy](https://proceedings.mlr.press/v267/ji25a.html) | 2025/ICML | `llm-nas`, `reflection`, `zero-cost`, `micro-macro` | [解析](parsed/2025-icml-rz-nas.md) | 复现公开代码，并统一候选、LLM 与最终训练预算 |
| codex_draft | [Resource-Efficient Iterative LLM-Based NAS with Feedback Memory](https://arxiv.org/abs/2603.12091) | 2026/arXiv | `llm-nas`, `memory`, `code-generation`, `single-gpu` | [解析](parsed/2026-arxiv-feedback-memory-nas.md) | 核对 proxy-to-full-training 转移、test-feedback 风险与多 search seeds |
| codex_draft | [Structured Progressive Knowledge Activation for LLM-Driven Neural Architecture Search](https://arxiv.org/abs/2605.04057) | 2026/ICML (paper claim) | `llm-nas`, `structured-editing`, `action-validity`, `clrs` | [解析](parsed/2026-icml-spark.md) | 复现五 seed 搜索并统一 attempts、LLM calls、GPU-hours 与最终训练预算 |
| codex_draft | [Delta-Based Neural Architecture Search: LLM Fine-Tuning via Code Diffs](https://arxiv.org/abs/2605.04903) | 2026/arXiv | `llm-nas`, `delta-editing`, `lora`, `single-epoch-proxy` | [解析](parsed/2026-arxiv-delta-nas.md) | 做单数据集 matched-corpus 消融，并用多 search seeds 与完整训练复核 |
| codex_draft | [LLM as a Tool, Not an Agent: Code-Mined Tree Transformations for Neural Architecture Search](https://arxiv.org/abs/2604.16555) | 2026/arXiv | `llm-nas`, `tree-search`, `module-mining`, `bayesian` | [解析](parsed/2026-arxiv-llmastool.md) | 获取作者代码，并统一候选、训练、GPU 与 LLM 成本复现 |
...
| Status | Paper | Year/Venue | Tags | Note | Next action |
|---|---|---|---|---|---|
| codex_draft | [Device-First Feedback: Toward Mobile-Native LLM-Driven Neural Architecture Search](https://arxiv.org/abs/2608.00078) | 2026/arXiv | `llm-nas`, `mixed-search-space`, `hardware-aware`, `mobile`, `test-feedback` | [解析](parsed/2026-arxiv-device-first-feedback.md) | 修复并冻结dataset/latency单位与mean/median口径，改用validation-only device feedback，再做matched-budget多seed Pareto复现 |
| codex_draft | [Similarity-Guided Curriculum Fine-Tuning of LLMs for Neural Architecture Synthesis](https://arxiv.org/abs/2607.11591) | 2026/arXiv | `llm-nas`, `mixed-search-space`, `curriculum`, `code-generation`, `minhash` | [解析](parsed/2026-arxiv-similarity-guided-curriculum-nas.md) | 用typed architecture distance和固定training recipe，对progressive/random/reverse/schema-only做多seed matched-budget复现 |
| codex_draft | [Closed-Loop LLM Discovery of Non-Standard Channel Priors in Vision Models](https://link.springer.com/chapter/10.1007/978-3-032-31920-3_42) | 2026/ICPR | `llm-nas`, `mixed-search-space`, `channel-search`, `code-generation`, `one-epoch-proxy` | [解析](parsed/2026-icpr-closed-loop-channel-priors.md) | 冻结 architecture-only action contract，补 matched-budget random/evolution、5+ search seeds、full training、trajectory manifest 与完整 LLM/GPU 成本 |
